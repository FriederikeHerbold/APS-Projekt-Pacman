...
//        pacman3up = new ImageIcon("images/pacman/up2.png").getImage();
//        pacman4up = new ImageIcon("images/pacman/up3.png").getImage();
//        pacman2down = new ImageIcon("images/pacman/down1.png").getImage();
//        pacman3down = new ImageIcon("images/pacman/down2.png").getImage();
//        pacman4down = new ImageIcon("images/pacman/down3.png").getImage();
//        pacman2left = new ImageIcon("images/pacman/left1.png").getImage();
//        pacman3left = new ImageIcon("images/pacman/left2.png").getImage();
//        pacman4left = new ImageIcon("images/pacman/left3.png").getImage();
...
//        pacman4right = new ImageIcon("images/pacman/right3.png").getImage();       
        pacman1 = new ImageIcon("images/test.png").getImage();
        pacman2up = new ImageIcon("images/test.png").getImage();
        pacman3up = new ImageIcon("images/test.png").getImage();
        pacman4up = new ImageIcon("images/test.png").getImage();
        pacman2down = new ImageIcon("images/test.png").getImage();
        pacman3down = new ImageIcon("images/test.png").getImage();
        pacman4down = new ImageIcon("images/test.png").getImage();
        pacman2left = new ImageIcon("images/test.png").getImage();
        pacman3left = new ImageIcon("images/test.png").getImage();
        pacman4left = new ImageIcon("images/test.png").getImage();
        pacman2right = new ImageIcon("images/test.png").getImage();
        pacman3right = new ImageIcon("images/test.png").getImage();
        pacman4right = new ImageIcon("images/test.png").getImage();
        spielfeld = new ImageIcon("images/spielfeld2.png").getImage();
    ...
    private void doDrawing(Graphics g) {
        ...
        g2d.drawImage(spielfeld, 0, 0, 720, 720, this);
