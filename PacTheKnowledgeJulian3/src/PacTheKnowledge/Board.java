...
public class Board extends JPanel implements ActionListener {
    ...
    private Image superstudent1, superstudent2up, superstudent2left, superstudent2right, superstudent2down;
    private Image superstudent3up, superstudent3down, superstudent3left, superstudent3right;
    private Image superstudent4up, superstudent4down, superstudent4left, superstudent4right;
...
//        initGame();
    ...
    private void drawScore(Graphics2D g) {
        ...
        for (i = 0; i < pacsLeft; i++) {
            g.drawImage(student3left, i * 28 + 8, SCREEN_SIZE + 1, this);
        }
    }
    ...
    private void drawPacmanUp(Graphics2D g2d, int pacman_x, int pacman_y) {
    	...
    	if(!student.getSuperMode()){
    		switch (student.getstudentAnimPos()) {
            case 1:
                g2d.drawImage(student2up, pacman_x + 1, pacman_y + 1, this);
                break;
            case 2:
                g2d.drawImage(student3up, pacman_x + 1, pacman_y + 1, this);
                break;
            case 3:
                g2d.drawImage(student4up, pacman_x + 1, pacman_y + 1, this);
                break;
            default:
                g2d.drawImage(student1, pacman_x + 1, pacman_y + 1, this);
                break;
    		}
    	}else{
    		switch (student.getstudentAnimPos()) {
            case 1:
                g2d.drawImage(superstudent2up, pacman_x + 1, pacman_y + 1, this);
                break;
            case 2:
                g2d.drawImage(superstudent3up, pacman_x + 1, pacman_y + 1, this);
                break;
            case 3:
                g2d.drawImage(superstudent4up, pacman_x + 1, pacman_y + 1, this);
                break;
            default:
                g2d.drawImage(superstudent1, pacman_x + 1, pacman_y + 1, this);
                break;
    		}
    	}
    }
    ...
    private void drawPacmanDown(Graphics2D g2d, int pacman_x, int pacman_y) {
    	...
    	if(!student.getSuperMode()){
    		switch (student.getstudentAnimPos()) {
            case 1:
                g2d.drawImage(student2down, pacman_x + 1, pacman_y + 1, this);
                break;
            case 2:
                g2d.drawImage(student3down, pacman_x + 1, pacman_y + 1, this);
                break;
            case 3:
                g2d.drawImage(student4down, pacman_x + 1, pacman_y + 1, this);
                break;
            default:
                g2d.drawImage(student1, pacman_x + 1, pacman_y + 1, this);
                break;
    		...
    		switch (student.getstudentAnimPos()) {
            case 1:
                g2d.drawImage(superstudent2down, pacman_x + 1, pacman_y + 1, this);
                break;
            case 2:
                g2d.drawImage(superstudent3down, pacman_x + 1, pacman_y + 1, this);
                break;
            case 3:
                g2d.drawImage(superstudent4down, pacman_x + 1, pacman_y + 1, this);
                break;
            default:
                g2d.drawImage(superstudent1, pacman_x + 1, pacman_y + 1, this);
                break;
    ...
    private void drawPacnanLeft(Graphics2D g2d, int pacman_x, int pacman_y) {
         ...
         if(!student.getSuperMode()){
    		switch (student.getstudentAnimPos()) {
            case 1:
                g2d.drawImage(student2left, pacman_x + 1, pacman_y + 1, this);
                break;
            case 2:
                g2d.drawImage(student3left, pacman_x + 1, pacman_y + 1, this);
                break;
            case 3:
                g2d.drawImage(student4left, pacman_x + 1, pacman_y + 1, this);
                break;
            default:
                g2d.drawImage(student1, pacman_x + 1, pacman_y + 1, this);
                break;
    		...
    		switch (student.getstudentAnimPos()) {
            case 1:
                g2d.drawImage(superstudent2left, pacman_x + 1, pacman_y + 1, this);
                break;
            case 2:
                g2d.drawImage(superstudent3left, pacman_x + 1, pacman_y + 1, this);
                break;
            case 3:
                g2d.drawImage(superstudent4left, pacman_x + 1, pacman_y + 1, this);
                break;
            default:
                g2d.drawImage(superstudent1, pacman_x + 1, pacman_y + 1, this);
                break;
    ...
    private void drawPacmanRight(Graphics2D g2d, int pacman_x, int pacman_y) {
    	...
    	if(!student.getSuperMode()){
    		switch (student.getstudentAnimPos()) {
            case 1:
                g2d.drawImage(student2right, pacman_x + 1, pacman_y + 1, this);
                break;
            case 2:
                g2d.drawImage(student3right, pacman_x + 1, pacman_y + 1, this);
                break;
            case 3:
                g2d.drawImage(student4right, pacman_x + 1, pacman_y + 1, this);
                break;
            default:
                g2d.drawImage(student1, pacman_x + 1, pacman_y + 1, this);
                break;
    		...
    		switch (student.getstudentAnimPos()) {
            case 1:
                g2d.drawImage(superstudent2right, pacman_x + 1, pacman_y + 1, this);
                break;
            case 2:
                g2d.drawImage(superstudent3right, pacman_x + 1, pacman_y + 1, this);
                break;
            case 3:
                g2d.drawImage(superstudent4right, pacman_x + 1, pacman_y + 1, this);
                break;
            default:
                g2d.drawImage(superstudent1, pacman_x + 1, pacman_y + 1, this);
                break;
    ...
    private void loadImages() {
        ...
        student1 = new ImageIcon("images/Student-vorne.png").getImage();
        ...
        superstudent1 = new ImageIcon("images/Super-Student-vorne.png").getImage();
        superstudent2up = new ImageIcon("images/Super-Student-oben.png").getImage();
        superstudent3up = new ImageIcon("images/Super-Student-oben.png").getImage();
        superstudent4up = new ImageIcon("images/Super-Student-oben.png").getImage();
        superstudent2down = new ImageIcon("images/Super-Student-unten.png").getImage();
        superstudent3down = new ImageIcon("images/Super-Student-unten.png").getImage();
        superstudent4down = new ImageIcon("images/Super-Student-unten.png").getImage();
        superstudent2left = new ImageIcon("images/Super-Student-links.png").getImage();
        superstudent3left = new ImageIcon("images/Super-Student-links.png").getImage();
        superstudent4left = new ImageIcon("images/Super-Student-links.png").getImage();
        superstudent2right = new ImageIcon("images/Super-Student-rechts.png").getImage();
        superstudent3right = new ImageIcon("images/Super-Student-rechts.png").getImage();
        superstudent4right = new ImageIcon("images/Super-Student-rechts.png").getImage();
    }
